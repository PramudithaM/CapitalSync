        ...
        <div className='flex items-center justify-center h-screen'>
          <div>
            <div className='h-180 bg-white rounded-[60px] relative overflow-hidden'>
              ...
              <div
                className={`absolute top-0 h-full w-1/2 bg-[#000325] bg-cover flex items-center justify-center transition-all duration-700 ${
                  isSignup
              ...
              <div className='flex h-full'>
                ...
                {/* LOGIN FORM */}
                <div
                  className={`w-1/2 px-30 py-20 flex flex-col justify-center transition-all duration-700 ${
                    isSignup
