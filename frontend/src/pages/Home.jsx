...
<<<<<<< Updated upstream
  ...
  const chartData = useMemo(() => getLast6MonthsData(), [incomes, expenses]);


  //Transaction History functionality has been removed because it was unused and caused redundant API calls on mount.
